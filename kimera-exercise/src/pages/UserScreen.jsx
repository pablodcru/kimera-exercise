    ...
    <div className="w-full h-full min-h-[100vh] bg-gradient-to-t from-[#E6A44D] to-[#F8D2A2] flex justify-center items-center">
      <div className="absolute top-5 left-10" onClick={() => navigate("/")}>
        <div className="flex items-center gap-2 hover:cursor-pointer">
          ...
          <p className="text-[#475569]  hover:underline hover:scale-105">
            Go Back
          </p>
        </div>
      </div>
      {!showLoader ? (
        ...
        {/* para pantallas pequeñas */}
          <div className="sm:visible hidden sm:block w-fit h-fit bg-gradient-to-t from-[#E6A44D] to-[#fffcf9] shadow-xl rounded-lg">
            <div className="flex flex-wrap">
              <div className="flex flex-col px-6 md:px-12 py-2 md:py-8 items-center justify-around text-slate-600">
                <div className="flex flex-col items-center">
                  <p className="text-4xl font-bold">
                    {location.state.name.first}
                  </p>
                  <p className="text-4xl font-bold">
                    {location.state.name.last}
                  </p>
                </div>
                <div>
              ...
              <img
                ...
                alt="user"
                className="grayscale h-60 md:h-80 w-auto rounded-r-lg"
              />
            </div>
          </div>
          {/* para pantallas mas de 640px */}
          <div className="sm:hidden  w-fit h-fit bg-gradient-to-t from-[#E6A44D] to-[#fffcf9] shadow-xl rounded-lg">
            <div className="flex flex-col">
              <img
                src={location.state.picture.large}
                alt="user"
                className="grayscale h-60 md:h-80 w-auto rounded-t-lg"
              />
              <div className="flex flex-col px-6 md:px-12 py-2 md:py-8 items-center justify-around text-slate-600">
                <div className="flex flex-col items-center">
                  <p className="text-4xl font-bold">
