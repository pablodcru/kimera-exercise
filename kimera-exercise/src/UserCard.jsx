...
export default function UserCard({user}) {
  let navigate = useNavigate()
    ...
    return (
        <div className="h-[15rem] w-48 bg-white flex flex-col items-center justify-between shadow-xl rounded-md hover:cursor-pointer hover:scale-110 transition-all ease-in-out" onClick={()=> navigate('/users', {state: user})} >
          <div className="mt-8 flex flex-col items-center">
            <img src={user.picture.thumbnail} alt="photo" className="w-[65px] h-65px] rounded-full" />
